...
function Wordmark({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      color: color || 'var(--pl-ink)',
      lineHeight: 1
    }
  }, "Pelon"), tagline && /*#__PURE__*/React.createElement(Payoff, {
    size: size * 0.36,
    color: taglineColor || 'var(--pl-ink-3)'
  })));
}
...
function Btn({
  ...
  const variants = {
    primary: {
      ...
      boxShadow: '0 8px 22px var(--pl-accent-glow)'
    },
    dark: {
...
function SequencedVideo({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, sources.map((src, i) => /*#__PURE__*/React.createElement("video", {
    key: src,
